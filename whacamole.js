...
function nehezseg() {
    if (document.getElementById("nehezseg").innerHTML == "Könnyű") {
        hard = true;
        easy_rekord = document.getElementById("rekord").innerHTML;
        document.getElementById("rekord").innerHTML = hard_rekord;
        document.getElementById("rekord").style.color = "red";
